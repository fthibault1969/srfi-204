...
;; MATCH-PROB first checks for problem patterns, otherwise passes
;; on to MATCH-TWO.

;; MATCH-EXTRACT-PROB extract problem patterns, otherwise
;; pass on to MATCH-EXTRACT-VARS.
